...
export const mockOrders: Order[] = [
  ...
  // ── 7. ENQUIRY ─────────────────────────────────────────────────────────────
  {
    ...
    lastUpdatedAt: isoTs(daysAgo(1), "15:45:00"),
    budgetRange: "Rs. 80,000 - Rs. 1,50,000",
    occasion: "Wedding gift",
    timelineNotes: "Needed within 3 weeks",
    selectedProducts: [
      {
        id: "enq-prod-chain-22k",
        productCode: "EVL-GN-4421",
        name: "Classic Rope Chain 22K",
        category: "Chain",
        metalType: "Gold",
        metalPurity: "22K",
        description:
          "Medium-weight rope chain in yellow gold. Customer prefers 50-60cm length.",
        basePrice: 68000,
        status: "ESTIMATED",
      },
      {
        id: "enq-prod-ring-18k",
        productCode: "EVL-RG-1108",
        name: "Solitaire Diamond Ring",
        category: "Ring",
        metalType: "Gold",
        metalPurity: "18K",
        description:
          "Classic solitaire setting for customer to compare against custom wedding pieces.",
        basePrice: 112000,
        status: "PENDING",
      },
    ],
    customProducts: [
      {
        ...
        stoneCut: "Polki",
        stoneQuality: "AAA",
        stoneCaratEstimate: 3.4,
        status: "PENDING",
        references: [
          {
            id: "ref-necklace-board",
            type: "link",
    ...
    estimations: [
      {
        id: "est-enq-chain-22k",
        productId: "enq-prod-chain-22k",
        metalWeight: 13.8,
        purity: "22K",
        stoneDetails: [],
        finalAmount: 92800,
        createdAt: isoTs(daysAgo(1), "11:15:00"),
      },
    ],
    activityFeed: [
      {
        ...
        postedBy: "Ananya S.",
        actorRole: "sales",
        timestamp: isoTs(daysAgo(2), "18:00:00"),
        type: "order_created",
        note: "Walk-in enquiry. Customer interested in multiple pieces for a wedding. Budget Rs. 80K-Rs. 1.5L. Needs within 3 weeks.",
      },
      {
        id: "act-enq001-1",
        orderId: "enq-001",
        postedBy: "Ananya S.",
        actorRole: "sales",
        timestamp: isoTs(daysAgo(1), "10:20:00"),
        type: "note",
        note: "Customer shortlisted two catalogue pieces and asked for options on a custom necklace set.",
      },
      {
        id: "act-enq001-2",
        orderId: "enq-001",
        postedBy: "System",
        timestamp: isoTs(daysAgo(1), "11:15:00"),
        type: "estimation_added",
        note: "Estimation of Rs. 92,800 added for Classic Rope Chain 22K",
      },
      {
        id: "act-enq001-3",
        orderId: "enq-001",
        postedBy: "Ananya S.",
        actorRole: "sales",
        timestamp: isoTs(daysAgo(1), "15:45:00"),
        type: "note",
        note: "Customer shared Pinterest board for the custom necklace. Shared with vendor for initial feasibility and quote.",
      },
    ],
  },
